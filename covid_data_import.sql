#Import covid deaths table as coviddeaths2, being as permissive
#as possible with the data to ensure 100% of rows are imported in:

#Create empty table with varchar(255) to be as permissive as possible
#with regards to what kinds of data are allowed:

drop table if exists CovidDeaths2;
